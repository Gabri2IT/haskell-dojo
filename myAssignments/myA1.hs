...
-- There are many other helpful list functions available 
-- in Haskell's Prelude and the `Data.List` module. We'll
-- use only some of them in this course, but we encourage you to explore the documentation for [Data.List](https://hackage.haskell.org/package/base-4.17.0.0/docs/Data-List.html) on Hoogle and familiarize yourself with its functions for future reference.
...
convertRowIndex c =  -65   (fromEnum toUpper <- c)